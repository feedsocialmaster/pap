 ...
 */
async function recalculateStockTotal(productId: string) {
 ...
 */
export const getVariants = async (req: AuthedRequest, res: Response) => {
  try {
 ...
 */
export const bulkUpdateVariants = async (req: AuthedRequest, res: Response) => {
  try {
    const { productId } = req.params;
