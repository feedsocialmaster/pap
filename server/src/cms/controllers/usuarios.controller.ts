...
export const getUsuarios = async (req: AuthedRequest, res: Response) => {
  try {
    const { 
      pagina = '1', 
      limite = '20',
...
export const getUsuarioPorId = async (req: AuthedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
// Crear nuevo usuario
export const crearUsuario = async (req: AuthedRequest, res: Response) => {
  try {
    const {
      email,
      password,
...
// Actualizar usuario
export const actualizarUsuario = async (req: AuthedRequest, res: Response) => {
  try {
    const { id } = req.params;
    const {
      email,
...
// Eliminar usuario
export const eliminarUsuario = async (req: AuthedRequest, res: Response) => {
  const { id } = req.params;
...
export const cambiarEstadoUsuario = async (req: AuthedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
export const getHistorialCompras = async (req: AuthedRequest, res: Response) => {
  try {
    const { id } = req.params;
