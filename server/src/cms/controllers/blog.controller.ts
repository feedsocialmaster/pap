...
export const getBlogPosts = async (req: AuthedRequest, res: Response) => {
  try {
...
export const getPublishedPosts = async (req: AuthedRequest, res: Response) => {
  try {
    const posts = await prisma.cMSBlogPost.findMany({
      where: {
        estado: 'PUBLICADO'
...
export const getBlogPostBySlug = async (req: AuthedRequest, res: Response) => {
  try {
...
export const getRelatedPosts = async (req: AuthedRequest, res: Response) => {
  try {
    const { slug } = req.params;
...
export const getBlogPostById = async (req: AuthedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
export const createBlogPost = async (req: AuthedRequest, res: Response) => {
  try {
    const {
      titulo,
      tituloSeo,
      ...
      cuerpo,
      estado,
      programadoPara // @deprecated - kept for backwards compatibility but ignored
    } = req.body;
 ...
 * Scheduling functionality has been removed from the CMS.
 */
export const updateBlogPost = async (req: AuthedRequest, res: Response) => {
  try {
    const { id } = req.params;
    const {
      titulo,
...
export const deleteBlogPost = async (req: AuthedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
export const archiveBlogPost = async (req: AuthedRequest, res: Response) => {
  try {
    const { id } = req.params;
