 ...
 */
export const STATE_TRANSITIONS: Record<CMSOrderStatus, CMSOrderStatus[]> = {
  // Estados iniciales
  PENDING: [
    'PAYMENT_APPROVED',
    'PAYMENT_REJECTED',
 ...
 */
export function getAvailableTransitions(order: Partial<Order>): CMSOrderStatus[] {
 ...
 */
export const FINAL_STATUSES: CMSOrderStatus[] = [
  'DELIVERED',
  'PAYMENT_REJECTED',
  'CANCELLED'
];
 ...
 */
export function isFinalStatus(status: CMSOrderStatus): boolean {
 ...
 */
export const IMMUTABLE_STATUSES: CMSOrderStatus[] = [
  'DELIVERED',
  'PAYMENT_REJECTED'
];
 ...
 */
export function isImmutableStatus(status: CMSOrderStatus): boolean {
 ...
 */
export const SHIPPING_FLOW: CMSOrderStatus[] = [
  'PENDING',
  'PAYMENT_APPROVED',
  'PREPARING',
  'READY_FOR_SHIPPING',
 ...
 */
export const PICKUP_FLOW: CMSOrderStatus[] = [
  'PENDING',
  'PAYMENT_APPROVED',
  'PREPARING',
  'READY_FOR_PICKUP',
 ...
 */
export function getExpectedFlow(fulfillmentType?: string | null): CMSOrderStatus[] {
...
// ============================================================================
// CAMPOS REQUERIDOS POR TRANSICIÓN
// ============================================================================

export interface RequiredFieldsMap {
  [key: string]: {
    deliveryReason?: boolean;
    notes?: boolean;
 ...
 */
export const REQUIRED_FIELDS_BY_TRANSITION: RequiredFieldsMap = {
 ...
 */
export function requiresUserConfirmation(status: CMSOrderStatus): boolean {
 ...
 */
export function canBeCancelled(status: CMSOrderStatus): boolean {
  return ![
    'DELIVERED',
    'PAYMENT_REJECTED',
    'CANCELLED',
 ...
 */
export function isInProgress(status: CMSOrderStatus): boolean {
  return ![
    'PENDING',
    'PAYMENT_REJECTED',
    'DELIVERED',
