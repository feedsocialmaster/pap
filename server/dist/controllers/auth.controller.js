import { z } from 'zod';
import { loginUser, registerUser, requestPasswordReset, requestUsernameRecovery, resetPasswordWithToken, verifyResetToken } from '../services/auth.service.js';
...
export async function recuperarUsername(req, res) {
    try {
