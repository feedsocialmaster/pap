 ...
 */
export async function getVentasRealizadas(req, res, next) {
    try {
 ...
 */
export async function getPedidosRealizados(req, res, next) {
    try {
 ...
 */
export async function getPedidosPendientes(req, res, next) {
    try {
        const { from, to, limit, offset } = req.query;
        const params = {
            status: ['PENDING'],
 ...
 */
export async function updatePedidoStatus(req, res, next) {
    try {
        const { id } = req.params;
 ...
 */
export async function getOrderTransitions(req, res, next) {
    try {
        const { id } = req.params;
 ...
 */
export async function getPedidosEnProceso(req, res, next) {
    try {
