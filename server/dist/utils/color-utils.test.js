...
import { isValidHexColor, normalizeHexColor, validateAndNormalizeColors, getDefaultColor, } from './color-utils.js';
describe('Color Utils', () => {
    ...
    describe('validateAndNormalizeColors', () => {
        ...
        it('should return null for non-array input', () => {
            expect(validateAndNormalizeColors('not an array')).toBe(null);
        });
        it('should return null for array with non-string elements', () => {
            const colors = ['#FF0000', 123, '#00FF00'];
            expect(validateAndNormalizeColors(colors)).toBe(null);
        });
    });
