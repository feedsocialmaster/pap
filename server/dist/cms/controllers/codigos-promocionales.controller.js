...
export const getCodigosPromocionales = async (req, res) => {
    try {
...
export const crearCodigoPromocional = async (req, res) => {
    try {
        const { codigo, descuento, tipoDescuento, tipoBundle, combinable, exclusivoConPromociones, activo } = req.body;
...
export const eliminarCodigoPromocional = async (req, res) => {
    try {
        const { id } = req.params;
